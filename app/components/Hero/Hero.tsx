...
const Hero = () => (
  <PageLayout>
    <div className="mx-3 flex h-[50rem] flex-col">
      <h1 className="mb-8 text-center text-hero text-slate-700">
        Hallo Cody*!
      </h1>
      ...
      <HeroParagraph>
        ...
        Cody. <br />
        We horen van veel mensen dat ze graag iets willen bijdragen hieraan,
        maar ze niet goed weten wat we willen.
      </HeroParagraph>
